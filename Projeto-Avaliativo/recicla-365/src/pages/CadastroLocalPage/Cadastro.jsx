                    ...
                    <Box component="form" onSubmit={handleSubmit} noValidate>
                        ...
                        <Box className={styles.formSection}>
                            ...
                            <Grid container spacing={2}>
                                <Grid xs={12}><TextField name="nome" required fullWidth id="nome" label="Nome Completo" autoFocus value={formData.nome} onChange={handleChange} /></Grid>
                                <Grid xs={12}><TextField name="cpf" required fullWidth id="cpf" label="CPF" value={formData.cpf} onChange={handleChange} /></Grid>
                                <Grid xs={12} sm={6}><TextField name="dataNascimento" required fullWidth id="dataNascimento" label="Data de Nascimento" type="date" InputLabelProps={{ shrink: true }} value={formData.dataNascimento} onChange={handleChange} /></Grid>
                                <Grid xs={12} sm={6}><TextField select label="Sexo" required fullWidth id="sexo" name="sexo" value={formData.sexo} onChange={handleChange}><MenuItem value="masculino">Masculino</MenuItem><MenuItem value="feminino">Feminino</MenuItem><MenuItem value="outro">Outro</MenuItem></TextField></Grid>
                            </Grid>
                        </Box>
