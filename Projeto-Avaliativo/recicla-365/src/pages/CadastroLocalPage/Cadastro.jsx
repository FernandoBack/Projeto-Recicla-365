...
const Cadastro = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const cpfExists = usersData.some(user => user.cpf.replace(/\D/g, '') === formData.cpf.replace(/\D/g, ''));
        if (cpfExists) {
                    ...
                    <Box component="form" onSubmit={handleSubmit} noValidate>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField name="senha" required fullWidth id="senha" label="Senha" type="password" autoComplete="new-password" value={formData.senha} onChange={handleChange} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
