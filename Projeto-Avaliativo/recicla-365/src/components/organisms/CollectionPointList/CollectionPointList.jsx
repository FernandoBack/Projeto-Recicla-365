...
const CollectionPointList = ({ points, showActions = false, onEdit, onDelete }) => {
    return (
                                ...
                                {showActions && (
                                    <TableCell align="right">
                                        <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 1 }}>
                                            <IconButton aria-label="edit" color="primary" onClick={() => onEdit(point)}>
                                                <EditIcon />
                                            </IconButton>
                                            <IconButton aria-label="delete" color="error" onClick={() => onDelete(point.id)}>
                                                <DeleteIcon />
                                            </IconButton>
                                        </Box>
                                    </TableCell>
